...
function draw() 
{
  ...
  if(rotationY != null && rotationX != null)
  {
    ...
    fill(0,0,255);
    ellipse(screen.width*map(cos(horizontalBubbleAngle+90),-1,1,0.10,0.90),(screen.height*0.15 / 2), radHorizontalBubble, radHorizontalBubble);
    ...
    fill(255,0,0);
    ellipse(screen.width*0.15/2, (screen.height*0.85)*map(cos(verticalBubbleAngle+90),-1,1,0.10,0.90), radVerticalBubble, radVerticalBubble);
